...
Com 10 anos de experiência na área de suporte executivo e gestão administrativa, Mateo Silva traz uma perspectiva única e valiosa para a TechVision Solutions. 
...
**Idiomas:** japonês, francês, espanhol, português

## 🎯 **RESPONSABILIDADES NA TECHVISION SOLUTIONS**
Como Assistente Executivo, Mateo Silva é responsável por:
...
## 📈 **OBJETIVOS E METAS**
Mateo Silva está focado(a) em contribuir para o crescimento sustentável da TechVision Solutions, aplicando sua experiência em suporte executivo e gestão administrativa para:
