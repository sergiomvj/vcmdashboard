...
Com 17 anos de experiência na área de gestão de projetos e inovação, Carlos Lopez traz uma perspectiva única e valiosa para a TechVision Solutions. 
...
**Idiomas:** português, japonês, espanhol

## RESPONSABILIDADES NA TECHVISION SOLUTIONS
Como Executivo, Carlos Lopez é responsável por:
...
## OBJETIVOS E METAS
Carlos Lopez está focado(a) em contribuir para o crescimento sustentável da TechVision Solutions, aplicando sua experiência em gestão de projetos e inovação para:
