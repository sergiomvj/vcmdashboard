...
Com 20 anos de experiência na área de gestão de operações e processos, Carmen Perez traz uma perspectiva única e valiosa para a TechVision Solutions. 
...
Como Executiva, Carmen Perez é responsável por:
...
## 📈 **OBJETIVOS E METAS**
Carmen Perez está focado(a) em contribuir para o crescimento sustentável da TechVision Solutions, aplicando sua experiência em gestão de operações e processos para:
