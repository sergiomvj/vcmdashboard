...
- **Especializacao:** Desenvolvimento de Sistemas e DevOps

## FORMACAO ACADEMICA
Bacharelado em Ciência da Computação e Certificações AWS

## EXPERIENCIA PROFISSIONAL
Com 15 anos de experiência na área de desenvolvimento de sistemas e devops, Carmen Lopez traz uma perspectiva única e valiosa para a TechVision Solutions. 
...
**Idiomas:** inglês, português, alemão, espanhol, francês

## RESPONSABILIDADES NA TECHVISION SOLUTIONS
Como Especialista Desenvolvimento de Sistemas e DevOps, Carmen Lopez é responsável por:
...
## OBJETIVOS E METAS
Carmen Lopez está focado(a) em contribuir para o crescimento sustentável da TechVision Solutions, aplicando sua experiência em desenvolvimento de sistemas e devops para:
